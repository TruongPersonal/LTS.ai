  ...
  return (
    <div className="w-full h-full min-h-0 bg-[var(--ui-video)] flex items-center justify-center overflow-hidden">
      {videoUrl && !visibleError ? (
        ...
        <div className="max-w-md p-8 text-center text-[var(--ui-danger)] flex flex-col items-center gap-3" role="alert">
        ...
        <div className="w-full h-full bg-[var(--ui-surface-subtle)] flex items-center justify-center p-8 animate-pulse" role="status">
          <div className="size-12 rounded-2xl ui-skeleton" />
        </div>
      )}
    </div>
  );
