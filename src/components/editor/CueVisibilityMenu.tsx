  ...
  return (
    ...
    >
      <button
        ...
        title={label || t('editor.visibility.details')}
        ...
        <div className="cue-visibility-popover" role="menu" aria-label={t('editor.visibility.title')}>
          ...
          >
            ...
            <span className="cue-visibility-option-copy">
              ...
              <small>{t('editor.visibility.metadataHint')}</small>
            </span>
            {metadataVisible && <Check className="size-4 cue-visibility-check" />}
          </button>
          <button
            type="button"
            role="menuitemcheckbox"
          ...
          >
            ...
            <span className="cue-visibility-option-copy">
              ...
              <small>{t('editor.visibility.sourceHint')}</small>
            </span>
            {sourceVisible && <Check className="size-4 cue-visibility-check" />}
          </button>
          {onToggleActions && (
            <button
              type="button"
            ...
            >
              ...
              <span className="cue-visibility-option-copy">
                ...
                <small>{t('editor.visibility.actionsHint')}</small>
              </span>
              {actionsVisible && <Check className="size-4 cue-visibility-check" />}
            </button>
          )}
        </div>
      )}
