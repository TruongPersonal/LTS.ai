    ...
    <div className="workspace-page ui-container py-9 sm:py-12 space-y-8">
      ...
      {loading ? (
        ...
        <div className="workspace-empty-state">
          <Search className="size-8 ui-soft" />
          <h2 className="text-base font-bold">{t('dashboard.noSearchResults.title')}</h2>
        </div>
      ) : projects.length === 0 ? (
        <div className="workspace-empty-state">
          <FolderPlus className="size-8 ui-soft" />
          <h2 className="text-base font-bold">{t('dashboard.empty.title')}</h2>
        </div>
      ) : (
